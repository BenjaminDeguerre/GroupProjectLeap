...
\begin{document}
	...
	\begin{titlepage}
		...
		\HRule \\[0.4cm]
		{ \huge \bfseries Writing Robot Application}\\[0.4cm] % Title of your document
		\HRule \\[1.5cm]
		...
		{\large 20 April 2017}\\[1cm] % Date, change the \today to a set date if you want to be precise
